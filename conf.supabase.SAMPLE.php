 ...
 * 1. Copy this file to: conf.supabase.php
 * 2. Ask team lead for the actual database password
 * 3. Replace TEAM_DB_PASSWORD_HERE with the real password
 * 4. Never commit conf.supabase.php to git!
 */
...
// Team Project: note taking app
// ============================================
$conf['db_type'] = 'pgsql';
$conf['db_host'] = 'db.jijtnvlbnafnqsskwkfd.supabase.co';
$conf['db_port'] = '5432';
$conf['db_user'] = 'postgres';
$conf['db_pass'] = 'TEAM_DB_PASSWORD_HERE';  // ⚠️ Get from team lead - DON'T commit!
